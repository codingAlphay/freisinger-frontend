  ...
  return (
    <footer className="p-10 pt-32 bg-darkbg">
      <div className='max-w-6xl px-6 mx-auto'>
        <div className="grid items-end w-full grid-cols-1 md:grid-cols-3 footer md:flex-row md:gap-x-32 text-neutral-content">
          ...
          <div className='flex flex-col w-full space-y-1'>
            ...
            <span className="text-lg font-extrabold text-white">Maschinenpark</span>
            <span className="text-lg font-extrabold text-white">Aktuelles</span>
            <span className="text-lg font-extrabold text-white">Zertifikate</span>
            <span className="text-lg font-extrabold text-white">Karriere</span>
          </div>
          <div className='flex flex-col w-full space-y-1'>
            <div className='flex flex-col space-y-1.5 text-center text-gray-300 md:text-left'>
              ...
              <span className="text-lg font-extrabold text-white">Pflegehinweise</span>
              <div>
                <div onClick={() => setLeistungenOpen(!isLeistungenOpen)} className="relative inline-flex items-center text-lg font-extrabold text-white duration-300 cursor-pointer">
                  Leistungen
