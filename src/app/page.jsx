    ...
    <PageWrapper>
      <div className="">
        ...
        <PageContainer className={"my-36 text-center"}>
          ...
          <FadeInY value={150} delay={0.3} className={"my-16"}>
            <div className="flex items-center justify-center w-full h-28 bg-zinc-950/20">
              <Text>INFINITE ITEM SLIDER AREA</Text>
            </div>
          </FadeInY>
        </PageContainer>
        <PageContainer>
        ...
        <PageContainer className={"text-center flex items-center flex-col pb-16"}>
          <FadeInY value={50} delay={.8} className={"my-8"}>
